...
ActiveRecord::Schema.define(version: 20180126140817) do
  ...
  create_table "folders", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["buyer_id"], name: "index_folders_on_buyer_id"
  end
  ...
  create_table "requests", force: :cascade do |t|
    ...
    t.index ["messages_id"], name: "index_requests_on_messages_id"
  end
  ...
  create_table "requisitions", force: :cascade do |t|
    ...
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
    t.index ["buyer_id"], name: "index_requisitions_on_buyer_id"
    t.index ["folder_id"], name: "index_requisitions_on_folder_id"
    t.index ["messages_id"], name: "index_requisitions_on_messages_id"
  end
